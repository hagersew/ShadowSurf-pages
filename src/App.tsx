            ...
            <GridItem>
              <Stack spacing={6}>
                ...
                <Text fontSize={{ base: 'md', md: 'lg' }} color="whiteAlpha.700" maxW="2xl">
                  Whether you&apos;re working late, reducing eye strain, or just prefer a darker interface, ShadowSurf gives you full control over how websites look.
                </Text>
          ...
          <Grid templateColumns={{ base: '1fr', md: '1fr 1fr' }} gap={6}>
            ...
            >
              ...
              <Text color="whiteAlpha.800" fontSize={{ base: 'md', md: 'lg' }}>
                Unlike basic dark mode extensions, ShadowSurf focuses on performance and usability. It avoids breaking website layouts while delivering a smooth dark browsing experience.
              </Text>
            </Box>
            ...
            >
              ...
              <Text color="whiteAlpha.800" fontSize={{ base: 'md', md: 'lg' }}>
                ShadowSurf does NOT track, collect, or share your data. Everything runs locally in your browser.
              </Text>
            </Box>
          </Grid>
